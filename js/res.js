...
const IMAGES = [
	...
	{"name": "TILE_Floor_HeavyPlated_A_EWWW", "src":"img/ship/floor/TILE_FLOOR_HeavyPlated_A_EWWW.png","anim":false},
	{"name": "TILE_Floor_Plated_D_WWEW", "src":"img/ship/floor/TILE_FLOOR_Plated_D_WWEW.png","anim":false},
	{"name": "TILE_Floor_ScrapPlated_F", "src":"img/ship/floor/TILE_FLOOR_ScrapPlated_F.png","anim":false},
	{"name": "TILE_Floor_Plated_D_WWEW", "src":"img/ship/floor/TILE_FLOOR_Plated_D_WWEW.png","anim":false},
	{"name": "TILE_Floor_DarkPlated_B_EEWE", "src":"img/ship/floor/TILE_FLOOR_DarkPlated_B_EEWE.png","anim":false},
	{"name": "TILE_Floor_HeavyPlated_D_EWWW", "src":"img/ship/floor/TILE_FLOOR_HeavyPlated_D_EWWW.png","anim":false},
	{"name": "TILE_Floor_DarkPlated_A_EWWW", "src":"img/ship/floor/TILE_FLOOR_DarkPlated_A_EWWW.png","anim":false},
	{"name": "TILE_Floor_Plain_H_WEWW", "src":"img/ship/floor/TILE_FLOOR_Plain_H_WEWW.png","anim":false},
	{"name": "TILE_Floor_Plain_A_EWWE", "src":"img/ship/floor/TILE_FLOOR_Plain_A_EWWE.png","anim":false},
	{"name": "TILE_Floor_Plain_G_EWWW", "src":"img/ship/floor/TILE_FLOOR_Plain_G_EWWW.png","anim":false},
	{"name": "TILE_Floor_HeavyPlated_B_EEWE", "src":"img/ship/floor/TILE_FLOOR_HeavyPlated_B_EEWE.png","anim":false},
	{"name": "TILE_Floor_Plain_D_EWWW", "src":"img/ship/floor/TILE_FLOOR_Plain_D_EWWW.png","anim":false},
	{"name": "TILE_Floor_HeavyPlated_C_EEWW", "src":"img/ship/floor/TILE_FLOOR_HeavyPlated_C_EEWW.png","anim":false},
	{"name": "TILE_Floor_Plain_E_EEWE", "src":"img/ship/floor/TILE_FLOOR_Plain_E_EEWE.png","anim":false},
	{"name": "TILE_Floor_Plain_F_EEWE", "src":"img/ship/floor/TILE_FLOOR_Plain_F_EEWE.png","anim":false},
	{"name": "TILE_Floor_Plain_C_EEWE", "src":"img/ship/floor/TILE_FLOOR_Plain_C_EEWE.png","anim":false},
	{"name": "TILE_Floor_Plain_B_EWWE", "src":"img/ship/floor/TILE_FLOOR_Plain_B_EWWE.png","anim":false},
	...
	{"name": "TILE_Wall_Inner_Bottom_Right", "src":"img/ship/TILE_Wall_Inner_Bottom_Right.png", "anim": false},
	{"name": "TILE_Wall_Inner_Bottom_Left", "src":"img/ship/TILE_Wall_Inner_Bottom_Left.png", "anim": false},
	...
	{"name": "TILE_Wall_Inner_Top_Left", "src":"img/ship/TILE_Wall_Inner_Top_Left.png", "anim": false},

	{"name": "TILE_Wall_Inner_Top_Right", "src":"img/ship/TILE_Wall_Inner_Top_Right.png", "anim": false},
	...
	{"name": "TILE_Floor_Bridge_C", "src":"img/ship/floor/TILE_FLOOR_Bridge_C.png", "anim":false},
	...
	{"name": "TILE_Wall_Start_WW", "src":"img/ship/TILE_Wall_Start_WW.png", "anim":false},
	{"name": "TILE_Wall_Pipes_WW", "src":"img/ship/TILE_Wall_Pipes_WW.png", "anim":false},
	{"name": "TILE_Wall_Top_Shifted_X_WW", "src":"img/ship/TILE_Wall_Top_Shifted_X_WW.png", "anim":false},
	{"name": "TILE_Wall_WW", "src":"img/ship/TILE_Wall_WW.png", "anim":false},
	{"name": "TILE_Wall_End_WW", "src":"img/ship/TILE_Wall_End_WW.png", "anim":false},

	{"name":"monster_blob", "src":"img/monster/monster_blob.png", "anim":false},
];
...
const STRUCTURE_TILES = [
	...
	{"name":"ship_hull_bottom_left_inner_corner","walkable":false, "passesLight":false, 				"tileImage":"TILE_Wall_Inner_Bottom_Left"},
	{"name":"ship_hull_bottom_right_inner_corner","walkable":false,"passesLight":false, 				"tileImage":"TILE_Wall_Inner_Bottom_Right"},
	...
	{"name":"ship_hull_top_left_inner_corner", 	 "walkable":false, "passesLight":false,				   	"tileImage":"TILE_Wall_Inner_Top_Left"},
	...
	{"name":"ship_hull_top_right_inner_corner",  "walkable":false, "passesLight":false,				   	"tileImage":"TILE_Wall_Inner_Top_Right"},
	...
	{"name":"ship_inner_wall_NS", 			 	 "walkable":false, "passesLight":false,				   	"tileImages":["TILE_Wall_Pipes_WW", "TILE_Wall_Top_Shifted_X_WW", "TILE_Wall_WW"]},
...
const STRUCTURE_MATRIX = [
	{"name":"ship_hull_left", 				      "matrix": [MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE, MATRIX_TILE,  MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY]},
	...
	{"name":"ship_hull_right", 				      "matrix": [MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE, MATRIX_TILE,  MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE]},
	{"name":"ship_hull_bottom", 			      "matrix": [MATRIX_TILE,  MATRIX_ANY,   MATRIX_TILE,  MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE]},
	...
	{"name":"ship_hull_top_left_corner",          "matrix": [MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE, MATRIX_SPACE, MATRIX_TILE]},
	...
	{"name":"ship_hull_top_left_inner_corner",    "matrix": [MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE, MATRIX_TILE,  MATRIX_TILE,  MATRIX_ANY]},
	{"name":"ship_hull_top_right_inner_corner",   "matrix": [MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY,   MATRIX_SPACE, MATRIX_SPACE, MATRIX_TILE,  MATRIX_ANY,   MATRIX_TILE,  MATRIX_TILE]},
	{"name":"ship_hull_bottom_right_inner_corner","matrix": [MATRIX_ANY,   MATRIX_TILE,  MATRIX_ANY,   MATRIX_ANY,   MATRIX_SPACE, MATRIX_TILE,  MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY]},
	{"name":"ship_hull_bottom_left_inner_corner", "matrix": [MATRIX_ANY,   MATRIX_TILE,  MATRIX_ANY,   MATRIX_TILE,  MATRIX_SPACE, MATRIX_SPACE, MATRIX_ANY,   MATRIX_SPACE, MATRIX_ANY]},
	...
	{"name":"ship_inner_wall_NS_start", 	      "matrix": [MATRIX_TILE,  MATRIX_TILE,  MATRIX_TILE,  MATRIX_TILE,  MATRIX_SPACE,  MATRIX_TILE,  MATRIX_TILE,  MATRIX_SPACE,  MATRIX_TILE]},
	{"name":"ship_inner_wall_NS", 	      		  "matrix": [MATRIX_TILE,  MATRIX_SPACE, MATRIX_TILE,  MATRIX_TILE,  MATRIX_SPACE,  MATRIX_TILE,  MATRIX_TILE,  MATRIX_SPACE,  MATRIX_TILE]},
	{"name":"ship_inner_wall_NS_end", 	      	  "matrix": [MATRIX_TILE,  MATRIX_SPACE, MATRIX_TILE,  MATRIX_TILE,  MATRIX_SPACE,  MATRIX_TILE,  MATRIX_TILE,  MATRIX_TILE,   MATRIX_TILE]},
];
